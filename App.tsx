...
//----- importação do mapa web com react native-----------
import React from 'react';
import { StyleSheet, View } from 'react-native';
import InternetHeatMap from './screens/InternetHeatMap'; // Ajuste o caminho se necessário
...
return (
    <View style={styles.container}>
    <StatusBar barStyle="light-content" backgroundCol